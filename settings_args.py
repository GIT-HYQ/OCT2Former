...
class basic_setting():
    ...
    parser.add_argument("--crop_size", type=tuple, default=(512, 512))
    parser.add_argument("--depths", type=list, default=[1, 2, 3])
    parser.add_argument("--patch_size", type=list, default=[4, 4, 4])
    #parser.add_argument("--patch_size", type=list, default=[4, 4, 4])
    # parser.add_argument("--vit_dims", type=list, default=[64, 128, 256, 512])
    parser.add_argument("--vit_dims", type=list, default=[32, 64, 128, 256])
